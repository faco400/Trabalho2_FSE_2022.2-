...
def CRC16(crc, data):
  return ((crc & 0xFF00) >> 8) ^ crc_table[(crc & 0x00FF) ^ (data & 0x00FF)]
...
if __name__ == '__main__':
  # print(calcCRC('\x01\x23'+C1+matricula, 7).to_bytes(4,'big'))
  # print(calcCRC(sample,7).to_bytes(5,'big'))
  crc = calcCRC(b'\x01\x23'+C1+matricula,7)
  print(crc)